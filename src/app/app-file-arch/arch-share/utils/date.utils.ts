 ...
 * @return number
 */
const getMillisecondsByDate = (date: Date): number => {
 ...
 * @return boolean
 */
const isBefore = (firstDate: Date, secondDate: Date): boolean => {
  const firstDateMilliseconds = getMillisecondsByDate(firstDate);
  const secondDateMilliseconds = getMillisecondsByDate(secondDate);
 ...
 * @return boolean
 */
const isEqual = (firstDate: Date, secondDate: Date): boolean => {
  const firstDateMilliseconds = getMillisecondsByDate(firstDate);
  const secondDateMilliseconds = getMillisecondsByDate(secondDate);
 ...
 * @return number
 */
const getMonthByDate = (date: Date): number => {
 ...
 * @return number
 */
const getYearByDate = (date: Date): number => {
 ...
 * @return number
 */
const getMonthGapDays = (year: number, month: number): number => {
